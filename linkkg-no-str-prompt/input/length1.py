...
def log_txt_word_counts(input_folder, log_path):
    with open(log_path, "w") as log:
        log.write("===== TXT FILE WORD COUNTS =====\n")
        ...
        for filename in os.listdir(input_folder):
            if filename.endswith(".txt"):
                ...
                try:
                    ...
                    log.write(f"{filename}: {word_count} words\n")
...
log_txt_word_counts(input_folder, log_path)
