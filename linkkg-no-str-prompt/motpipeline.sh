...
#SBATCH --output=/projects/cdomenic/HS_CINA/Dipak/slurm_outputs/$FILENAME-runpipeline.%j.out	
#SBATCH --error=/projects/cdomenic/HS_CINA/Dipak/slurm_outputs/$FILENAME-runpipeline.%j.err
#SBATCH --nodes=1
